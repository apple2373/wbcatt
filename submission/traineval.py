...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--val", default="./pbc_attr_v1_val.csv", help="Path to the validation CSV file"
    )
    parser.add_argument(
    ...
    parser.add_argument(
        "--use_eval_mode",
        action="store_true",
        help="Use model.eval() even for training. ResNet often improves the performance with this.",
    )
    parser.add_argument(
        "--resume", default=None, help="Path to a pretrained model"
    )
    parser.add_argument(
        "--logdir", default="./log", help="directory to save experiment logs"
    )
    parser.add_argument("--seed", default=1, type=int, help="random seed.")
    parser.add_argument(
        "--workers", type=int, default=8, help="workers for torch.utils.data.DataLoader"
    )
